                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('rooms.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="capacite" class="block mt-1 w-full" type="number" name="capacite" :value="old('capacite')" min="1" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="surface" class="block mt-1 w-full" type="number" step="0.01" name="surface" :value="old('surface')" />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="equipment" name="equipment" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" rows="3">{{ old('equipment') }}</textarea>
